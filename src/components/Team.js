...
function SocialIcons() {
  return (
    <div className="flex items-center gap-3">
      <a href="#contact" aria-label="Email" className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#BF7AB4]/15 text-[#A64195] transition-colors hover:text-[#964196]">
      ...
      <a href="#contact" aria-label="LinkedIn" className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#BF7AB4]/15 text-[#A64195] transition-colors hover:text-[#964196]">
      ...
      <a href="#publications" aria-label="Scholar" className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#BF7AB4]/15 text-[#A64195] transition-colors hover:text-[#964196]">
    ...
    <section id="people" className="py-14 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-[1280px]">
        ...
        <Link href="/faculty" className="group mt-10 block">
          <article className="rounded-2xl border border-[#BF7AB4]/30 bg-white px-6 py-6 shadow-[0_2px_14px_rgba(166,65,149,0.06)] transition-all duration-200 hover:border-[#BF7AB4]/50 hover:shadow-[0_8px_28px_rgba(166,65,149,0.12)] sm:px-8 sm:py-8">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
              ...
              <div className="min-w-0 flex-1">
                <span className={`${inter.className} inline-flex rounded-full bg-[#BF7AB4]/15 px-3 py-1 text-xs font-medium text-[#A64195]`}>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
          {members.map((member, index) => (
            <article key={member.name} className="rounded-2xl border border-[#BF7AB4]/30 bg-white px-5 py-6 text-center shadow-[0_2px_14px_rgba(166,65,149,0.06)]">
              ...
              <div className="mt-4 border-t border-[#BF7AB4]/30 pt-3">
