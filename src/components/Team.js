  ...
  return (
    <div className="flex items-center gap-3">
      <a
        href="#contact"
        aria-label="Email"
        className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-600 transition-colors hover:text-slate-900"
      >
  ...
  return (
    <section id="people" className="py-14 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-[1280px]">
        ...
        <article className="mt-10 rounded-2xl border border-slate-200 bg-white px-6 py-6 shadow-[0_2px_14px_rgba(15,23,42,0.06)] sm:px-8 sm:py-8">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h3 className={`${playfair.className} mt-2 text-[2rem] font-semibold leading-tight text-[#0D1733] sm:text-[2.3rem]`}>
                Dr. K. V. Vamsi
              </h3>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
          {members.map((member, index) => (
            <article
              key={member.name}
              className="rounded-2xl border border-slate-200 bg-white px-5 py-6 text-center shadow-[0_2px_14px_rgba(15,23,42,0.06)]"
            >
              <Image
                src={member.image}
                alt={member.name}
              ...
              <p className={`${inter.className} mt-3 min-h-[56px] text-[0.98rem] leading-relaxed text-[#4B607E]`}>
                {member.summary}
              </p>
